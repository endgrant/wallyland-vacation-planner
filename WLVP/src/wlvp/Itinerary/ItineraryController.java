...
public class ItineraryController {
    ...
    public void showItinerary() {
        ...
        // Converts the list to a string array for the JList
        String[] eventStrings = events.stream()
                .map(EventSlot::toString)
                .toArray(String[]::new);

        itineraryView.updateItineraryList(eventStrings);
    }
